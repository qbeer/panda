...
void ana_ntp_qa_complete_nofit_aolar(int nevts = 10000)
{
  ...
  TFile *out = TFile::Open(prefix + "_nofit_output_ana.root", "RECREATE");
  ...
  RhoCandList pbarp, muplus, muminus, piplus, piminus, jpsi, psi2s;
  ...
  while (theAnalysis->GetEvent() && i++ < nevts)
  {
    ...
    if(i%10 == 0) std::cout << "EVENT: #" << i << std::endl;
